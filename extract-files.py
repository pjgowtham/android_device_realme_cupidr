...
blob_fixups: blob_fixups_user_type = {
    ...
    ('odm/lib64/libarcsoft_dualcam_refocus_preview.so', 'odm/lib64/libarcsoft_high_dynamic_range_v4.so', 'odm/lib64/libarcsoft_portrait_super_night_raw.so', 'odm/lib64/libarcsoft_super_night_raw.so'): blob_fixup()
